...
%gabor_wavelet_2d Returns wavelet (size u,v) for 2d gabor filter

% Parameters:
%     width: Number of columns in 2d gabor kernel (an odd integer number, usually 39)
%     height: Number of rows in 2d gabor kernel (an odd integer number, usually 39)
%     u: Number of scales (usually 5)
%     v: Number of orientations (usually 8)
